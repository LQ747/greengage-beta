...
@Component({
  selector: 'app-user-farm-cahrt',
  templateUrl: './user-farm-cahrt.component.html',
  styleUrls: ['./user-farm-cahrt.component.scss']
})
export class UserFarmCahrtComponent implements OnInit {
  ...
  constructor(private measurmentService: MeasurmentService,
    private location: Location, private route: ActivatedRoute )
     { 
      ...
      this.measurmentService.getMeasurementDevice(id)
      .subscribe(
