...
@Component({
  selector: 'app-farm-charts',
  templateUrl: './farm-charts.component.html',
  styleUrls: ['./farm-charts.component.scss']
})
export class FarmChartsComponent implements OnInit {
  ...
  constructor(private measurmentService: MeasurmentService,
    private location: Location, private route: ActivatedRoute )
     { 
      ...
      this.measurmentService.getAllMeasurment(id)
      .subscribe(
